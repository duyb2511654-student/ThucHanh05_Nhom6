...
Đối với nội dung đa phương tiện, dự án có tệp LoiIchCongNgheSo_Infographic.png được thiết kế bằng công cụ Canva AI Magic Design và tệp LoiIchCongNgheSo_Video.mp4 là đoạn phim ngắn 30 giây giới thiệu về lợi ích công nghệ được biên tập qua CapCut. Phần mã nguồn của dự án bao gồm tệp index.html dùng để hiển thị các sản phẩm này trên giao diện web, với sự hỗ trợ lập trình từ GitHub Copilot.
